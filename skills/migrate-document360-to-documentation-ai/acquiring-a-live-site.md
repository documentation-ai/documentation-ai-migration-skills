...
- Fetch through `documentation-ai-migrate acquire --profile document360 [--urls <json>]` using Firecrawl's explicit safe settings or the local fetcher, which honours robots unless `--customer-authorised`.
